---
title: "02-0_R_Tidy_intro"
format: html
toc: TRUE
editor: visual
---

# Week 2 - The R Language and Tidy Data
...
2.  Work through the Posit Cloud R Basics Recipes, which are in this document below and also available here: [Posit Cloud R Basics Recipes](https://posit.cloud/learn/primers).
...
7.  Use a data dictionary. Keep data in a data file, **use a complimentary README file (or a metadata/annotation sheet)** that contains 'metadata'.
    ...
    -   [There is an example README](images/VT_COVID-19_Cases_by_County_Time_Series_modify_README.rtf) from the Vermont Covid dashboard in the images folder, "images/VT_COVID-19_Cases_by_County_Time_Series_modify_README.rtf".
