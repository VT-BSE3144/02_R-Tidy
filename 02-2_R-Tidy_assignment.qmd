...
Create an R-script in the code chunk below that converts a flowrate of ftˆ3/second to mˆ3/s. Include the following: - header - flowrate variable in ftˆ3/second that is equal to 1,500 - an equation that creates a new flowrate variable in mˆ3/s - the printed value of the new variable in mˆ3/s
